...
public class KFZ {
    ...
    private static String erstelleKennzeichenBuchstaben() {
        ...
        String kennzeichenBuchstaben = Eingabe.getEingabeString("Bitte geben Sie die 1- maximal 2 Buchstaben ihres (Wunsch)Kennzeichens ein:", "nurA-Z", "[A-Za-z]+", 1, 2).toUpperCase();
    ...
    public boolean isHUAUNachweisGueltig() {
        ...
        return (this.huAu != null) && !this.huAu.isBefore(currentYearMonth) && !this.huAu.equals(currentYearMonth);
    }
}
