...
public class KFZ {
    ...
    public KFZ() {
        this.kennzeichen = "noch nicht vergeben";
    }
...
//-------------------------------------------------Methoden-------------------------------------------------------------------------------
    ...
    public void anmelden() {
        if (!angemeldet) {
            KennzeichenVerwaltung.anmeldenKennzeichen(kennzeichen);
            setAngemeldet(true);
        }
    }
    ...
    public void abmelden() {
        if (getAngemeldet()) {
            KennzeichenVerwaltung.abmeldenKennzeichen(kennzeichen);
            setAngemeldet(false);
        }
    }
    ...
    public static KFZ erstelleKFZ(KFZ_Enum kfzEnum) {
        ...
        String marke = getEingabeString("Bitte geben Sie die Marke ein: ", fehlerMeldungen.get("marke"), "[A-Za-z]+", 1, 15);
        String modell = getEingabeString("Bitte geben Sie die Modell ein: ", fehlerMeldungen.get("modell"), "[A-Za-zÄÖÜäöü0-9 ]+", 1, 20);
        ...
        String farbe = getEingabeString("Bitte geben Sie die Grundfarbe des KFZ's ein: ", fehlerMeldungen.get("farbe"), "[A-Za-zÄÖÜäöü ]+", 1, 15);
        String identifikationsnummer = getEingabeString("Bitte geben Sie die 17-stellige Identifikationsnummer ein:", fehlerMeldungen.get("identifikationsnummer"), "[A-Za-z0-9]+", 17, 17);
    ...
    public static String erstelleKennzeichen(Halter halter) {
        ...
        if (!halter.getZugelasseneKennzeichen().contains(kennzeichenKomplett)) {
            halter.setZugelasseneKennzeichen(kennzeichenKomplett);
            return kennzeichenKomplett;
        } else {
            System.out.println("Das Kennzeichen: " + kennzeichenKomplett + " ist leider schon vergeben. Versuchen sie es bitte erneut.");
            return erstelleKennzeichen(halter);
        }
    }
    ...
    private static String erstelleKennzeichenBuchstaben() {
        ...
        String kennzeichenBuchstaben = getEingabeString("Bitte geben Sie die 1- maximal 2 Buchstaben ihres (Wunsch)Kennzeichens ein:", "", "[A-Za-z]+", 1, 2).toUpperCase();
    ...
    public void setzeHuAu(int baujahr) {
        ...
        this.huAu = YearMonth.of(jahr, monat);

    }
    private static HashMap<String, String> getStringStringHashMap() {
        HashMap<String, String> fehlerMeldungen = new HashMap<>();
        fehlerMeldungen.put("marke", "Bitte nur Buchstaben eingeben. Umlaute, Zahlen und Sonderzeichen sind ausgeschlossen.");
