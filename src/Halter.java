...
public class Halter {
    ...
    public void addZugelasseneAutosPerHalter(KFZ zugelassenesKFZ) {
        this.zugelasseneAutosPerHalter.add(zugelassenesKFZ);
    }

    public void removeZugelasseneAutosPerHalter(KFZ zugelassenesKFZ) {
        this.zugelasseneAutosPerHalter.remove(zugelassenesKFZ);
    }
    ...
    public void addZugelasseneKennzeichen(String zugelasseneKennzeichen) {
        this.zugelasseneKennzeichen.add(zugelasseneKennzeichen);
    }

    public void removeZugelasseneKennzeichen(String zugelasseneKennzeichen) {
        this.zugelasseneKennzeichen.remove(zugelasseneKennzeichen);
    }
    ...
    public void aktualisiereHUAUNachweis(KFZ kfz) {
        setHuAuNachweis(kfz.isHUAUNachweisGueltig() && !kfz.getAngemeldet());
    }
